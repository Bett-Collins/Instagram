...
urlpatterns = [
  ...
  re_path('^comment/(?P<image_id>\d+)$',main_views.commenting,name='commenting'),
  re_path('^likes/(?P<image_id>\d+)$',main_views.likes,name='likes'),
  re_path('^allcomments/(?P<image_id>\d+)$',main_views.allcomments,name='allcomments'),
  re_path('^search/$',main_views.search,name='search'),
